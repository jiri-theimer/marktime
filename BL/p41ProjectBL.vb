Public Interface Ip41ProjectBL
    ...
    Function GetGridDataSource(strCols As String, myQuery As BO.myQueryP41) As DataTable
...
Class p41ProjectBL
    ...
    Function GetGridDataSource(strCols As String, myQuery As BO.myQueryP41) As DataTable Implements Ip41ProjectBL.GetGridDataSource
