    ...
    Private Sub InhaleP28ColList(ByRef lis As List(Of BO.GridColumn))
        With lis
            ...
            If Factory.TestPermission(BO.x53PermValEnum.GR_P31_AllowRates) Then
                ...
                .Add(AGC("Vykázané výdaje", "Vykazano_Vydaje", BO.cfENUM.Numeric2, , "alfa.Vykazano_Vydaje", True, "LEFT OUTER JOIN tview_p28_worksheet(@dp31f1,@dp31f2) alfa ON a.p28ID=alfa.p41ID", "Vykázáno"))
                ...
                .Add(AGC("WIP/Odměny", "WIP_Odmeny", BO.cfENUM.Numeric2, , "beta.Odmeny", True, "LEFT OUTER JOIN tview_p28_wip(@dp31f1,@dp31f2) beta ON a.p28ID=beta.p28ID", "WIP"))
