...
Class j74SavedGridColTemplateBL
    ...
    Private Sub InhaleP31ColList(ByRef lis As List(Of BO.GridColumn))
        ...
        With lis
            ...
            .Add(AGC(My.Resources.common.Mena, "j27Code_Billing_Orig"))
    ...
    Private Sub InhaleP56ColList(ByRef lis As List(Of BO.GridColumn))
        With lis
            ...
            .Add(AGC(My.Resources.common.PrioritaZadavatele, "p59NameSubmitter"))
            ...
            .Add(AGC(My.Resources.common.VykazaneHodiny, "Hours_Orig", BO.cfENUM.Numeric2, , , True))
