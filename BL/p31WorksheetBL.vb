Public Interface Ip31WorksheetBL
    ...
    Function GetGridDataSource(strCols As String, myQuery As BO.myQueryP31) As DataTable
...
Class p31WorksheetBL
    ...
    End Function
    Public Function GetList_ApprovingFramework(x29id As BO.x29IdEnum, myQuery As BO.myQueryP31, intJ70ID As Integer) As IEnumerable(Of BO.ApprovingFramework) Implements Ip31WorksheetBL.GetList_ApprovingFramework
        Return _cDL.GetList_ApprovingFramework(x29id, myQuery, intJ70ID)
    End Function
    ...
    End Function
    Public Function GetGridDataSource(strCols As String, myQuery As BO.myQueryP31) As DataTable Implements Ip31WorksheetBL.GetGridDataSource
