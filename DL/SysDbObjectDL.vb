Public Class SysDbObjectDL
    ...
    Public Function GetList_SysObjects() As IEnumerable(Of BO.SysDbObject)
        Dim s As String = "SELECT ID,name,xtype,schema_ver as version,convert(text,null) as content FROM sysobjects WHERE rtrim(xtype) IN ('V','FN','P','TR') AND name not like 'dt_%' and (name not like 'sys%' or name like 'system_%') order by xtype,name"
