        ...
        With Master.Factory
            Select Case ViewState("prefix")
                ...
                Case "x27"
                    ...
                    grid1.DataSource = lis
                Case "x28"
                    Dim lis As IEnumerable(Of BO.x28EntityField) = .x28EntityFieldBL.GetList(BO.x29IdEnum._NotSpecified, -1)
                    grid1.DataSource = lis
                Case "x23"
                ...
                Case "x25"
                    ...
                    grid1.DataSource = lis
                Case "x18"
                    Dim lis As IEnumerable(Of BO.x18EntityCategory) = .x18EntityCategoryBL.GetList(mqDef)
                    grid1.DataSource = lis
                Case "x46"
