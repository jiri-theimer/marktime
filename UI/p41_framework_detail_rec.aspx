<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Clue.Master" CodeBehind="p41_framework_detail_rec.aspx.vb" Inherits="UI.p41_framework_detail_rec" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function sw_local(url, iconUrl, is_maximize) {
            window.parent.sw_decide(url, iconUrl, is_maximize);
        }
        function p31_recurrence_record(pid) {
            window.parent.sw_decide("p31_record.aspx?pid=" + pid, "Images/worksheet.png");

        }
        function p30_binding() {
            window.parent.sw_decide("p30_binding.aspx?masterprefix=p41&masterpid=<%=master.datapid%>", "Images/person.png", false);
        }
    </script>
</asp:Content>
