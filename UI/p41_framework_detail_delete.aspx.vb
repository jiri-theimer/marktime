...
Public Class p41_framework_detail_delete
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            With Master
                ...
                Server.Transfer("entity_framework_rec_p31.aspx?p31tabautoquery=time&masterprefix=p41&masterpid=" & .DataPID.ToString)     'testování
                ...
                With .Factory.j03UserBL
                    ...
                    ''End If
                    If Request.Item("force") = "comment" Then Me.CurrentTab = "workflow"
                    If Request.Item("force") = "detail" Then Me.CurrentTab = "p41"
