    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server">
        <telerik:RadPageView ID="core" runat="server" Selected="true">
            ...
            <div class="content-box2">
                ...
                <div class="content">
                    <asp:RadioButtonList ID="j02IsIntraPerson" runat="server" AutoPostBack="true" RepeatDirection="Vertical">
                        <asp:ListItem Text="Interní osoba v systému, kterou můžete svázat s uživatelským účtem (interní personální zdroj pro výkaznictví, plánování a reporting)" Value="1" Selected="true"></asp:ListItem>
                        <asp:ListItem Text="Pouze kontaktní osoba, kterou můžete svázat se záznamem klienta a projektu" Value="0"></asp:ListItem>
                    </asp:RadioButtonList>
            ...
            <table cellpadding="5" cellspacing="2">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblj02Code" Text="Kód/osobní číslo:" runat="server" CssClass="lbl" AssociatedControlID="j02Code"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblJ07ID" Text="Pozice (hladina sazby):" runat="server" CssClass="lbl"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblC21ID" Text="Pracovní fond:" runat="server" CssClass="lbl"></asp:Label></td>
                    <td>
                ...
                <tr valign="top" id="trJ17ID" runat="server">
                    ...
                    <td>
                        ...
                        <span class="infoInForm">Vazba na [Stát] se využívá kvůli zohlednění dnů svátků pro pracovní fondy osob z různých zemí (států).</span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:Label ID="Label3" Text="TEL2 (pevný):" runat="server" CssClass="lbl" AssociatedControlID="j02Phone"></asp:Label>
                ...
                <tr id="trJobTitle" runat="server">
                    <td>
                        <asp:Label ID="lblj02JobTitle" Text="Pozice:" runat="server" CssClass="lbl" AssociatedControlID="j02JobTitle"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" Text="Kancelář:" runat="server" CssClass="lbl" AssociatedControlID="j02Office"></asp:Label>
                    </td>
                    <td>
                ...
                <tr valign="top">
                    <td>
                        <asp:Label ID="lblj02EmailSignature" Text="Podpis pro e-mail:" runat="server" CssClass="lbl" AssociatedControlID="j02EmailSignature"></asp:Label>
                    </td>
                    <td>
        ...
        <telerik:RadPageView ID="other" runat="server">
            <table cellpadding="5" cellspacing="2">
                <tr>
                    <td>
                        <asp:Label ID="lblj02RobotAddress" runat="server" Text="Adresa pro IMAP robota:" CssClass="lbl"></asp:Label>
                    </td>
                    <td>
