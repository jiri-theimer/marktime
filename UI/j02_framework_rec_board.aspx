<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SubForm.Master" CodeBehind="j02_framework_rec_board.aspx.vb" Inherits="UI.j02_framework_rec_board" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function hardrefresh(pid, flag) {
            ...
            location.replace("j02_framework_rec_board.aspx?pid=<%=master.datapid%>");
        }
