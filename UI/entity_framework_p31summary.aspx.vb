...
Public Class entity_framework_p31summary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            With Master
                ...
                ''        Case "p56" : imgEntity.ImageUrl = "Images/task_32.png"
                ''    End Select
                ''End If
            ...
            SetupJ70Combo(BO.BAS.IsNullInt(Master.Factory.j03UserBL.GetUserParam("p31_drilldown-j70id")))
    ...
    Private Sub ReloadPage()
        Response.Redirect("entity_framework_p31summary.aspx?masterprefix=" & Me.CurrentMasterPrefix & "&masterpid=" & Me.CurrentMasterPID.ToString, True)
    End Sub
    ...
    Private Sub j70ID_SelectedIndexChanged(sender As Object, e As EventArgs) Handles j70ID.SelectedIndexChanged
        Master.Factory.j03UserBL.SetUserParam("p31_drilldown-j70id", Me.j70ID.SelectedValue)
        ReloadPage()
    End Sub
    ...
    Private Sub grid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles grid1.ItemDataBound
        ...
        If Not cRec.Item("prefix") Is System.DBNull.Value Then
            ...
            Select Case cRec.Item("prefix")
                Case "p41"
                    b = Master.Factory.SysUser.j04IsMenu_Project
                Case "p28"
                    b = Master.Factory.SysUser.j04IsMenu_Contact
                Case "p91"
                    b = Master.Factory.SysUser.j04IsMenu_Invoice
                Case "j02"
                    b = Master.Factory.SysUser.j04IsMenu_People
            End Select
            If b Then
