<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="o23_framework.aspx.vb" Inherits="UI.o23_framework" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function x18id_onchange(ctl) {
            ...
            location.replace("o23_framework.aspx?x18id=" + ctl.value);
        }
        ...
        function SavePaneWidth(w) {
            ...
            var keyname = "o23_framework-navigationPane_width-<%=me.currentx18id%>";
        ...
        function hardrefresh(pid, flag) {
            ...
            location.replace("o23_framework.aspx?pid=" + pid + "&x18id=<%=Me.CurrentX18ID%>");
        }
