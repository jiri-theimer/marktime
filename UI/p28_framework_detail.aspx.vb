        ...
        If Not Page.IsPostBack Then
            ...
            With Master.Factory.j03UserBL
                If Request.Item("tab") <> "" Then
                    .SetUserParam("p28_framework_detail-tab", Request.Item("tab"))
                End If
                .InhaleUserParams("p28_framework_detail-pid", "p28_framework_detail-tab")
