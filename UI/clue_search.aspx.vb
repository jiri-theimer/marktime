        ...
        If Not Page.IsPostBack Then
            With Master
                ...
                With .Factory.j03UserBL
                    ...
                    basUI.SelectDropdownlistValue(Me.cbxP41Top, .GetUserParam("handler_search_project-toprecs", "50"))
                    basUI.SelectDropdownlistValue(Me.cbxP28Top, .GetUserParam("handler_search_contact-toprecs", "50"))
                End With
            ...
            End With
        End If
        Me.p41id_search.radComboBoxOrig.DropDownWidth = Unit.Parse("400px")
        Me.p28id_search.radComboBoxOrig.DropDownWidth = Unit.Parse("400px")
        Me.j02id_search.RadCombo.DropDownWidth = Unit.Parse("400px")
        Me.p91id_search.RadComboOrig.DropDownWidth = Unit.Parse("400px")
