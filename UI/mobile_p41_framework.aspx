...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul class="nav nav-pills">        
        <li role="presentation" id="liP56_Actual" runat="server" visible="false"><a href="#">Otevřené úkoly
            <asp:Label runat="server" ID="CountP56_Actual" CssClass="badge"></asp:Label></a></li>
        <li role="presentation" id="liP56_Closed" runat="server" visible="false"><a href="#">Uzavřené úkoly
            <asp:Label runat="server" ID="CountP56_Closed" CssClass="badge"></asp:Label></a></li>
        <li role="presentation" id="lisP91" runat="server" visible="false"><a href="#">Vystavené faktury
            ...
            <asp:Panel ID="boxP31" runat="server" CssClass="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <div class="caption">
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" Text="Worksheet" NavigateUrl="#"></asp:HyperLink>                        
            ...
            <asp:Panel ID="boxO23" runat="server" CssClass="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <div class="caption">
                        ...
                        <a href="#">Dokumenty <asp:Label runat="server" ID="CountO23" CssClass="badge"></asp:Label></a>
