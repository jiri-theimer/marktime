...
Public Class o23_framework
    ...
    Private Sub o23_framework_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            With Master
                ...
                With lisPars
                    .Add("o23_framework-pagesize")
                    .Add("o23_framework-navigationPane_width-" & strX18ID)
                    .Add("o23_framework-x18id")
                    .Add("o23_framework-x23id")
                    .Add("o23_framework_detail-pid-" & strX18ID)

                    .Add("o23_framework-sort-" & strX18ID)
                    .Add("periodcombo-custom_query")
                    .Add("o23_framework-periodtype-" & strX18ID)
                    .Add("o23_framework-period-" & strX18ID)
                    .Add("o23_framework-filter_setting-" & strX18ID)
                    .Add("o23_framework-filter_sql-" & strX18ID)
                    .Add("o23_framework-filter_validity-" & strX18ID)
                ...
                With .Factory.j03UserBL
                    ...
                    basUI.SelectDropdownlistValue(Me.cbxo23Validity, .GetUserParam("o23_framework-filter_validity-" & strX18ID, "1"))
                    basUI.SelectDropdownlistValue(cbxPaging, .GetUserParam("o23_framework-pagesize", "20"))
                    Dim strDefWidth As String = "800"
                    Dim strW As String = .GetUserParam("o23_framework-navigationPane_width-" & strX18ID, strDefWidth)
                    If strW = "-1" Then
                    ...
                    If .GetUserParam("o23_framework-sort-" & strX18ID) <> "" Then
                        grid1.radGridOrig.MasterTableView.SortExpressions.AddSortExpression(.GetUserParam("o23_framework-sort-" & strX18ID))
                    End If
                    basUI.SelectDropdownlistValue(Me.cbxPeriodType, .GetUserParam("o23_framework-periodtype-" & strX18ID, ""))
                    If Me.cbxPeriodType.SelectedIndex > 0 Then
                        period1.SetupData(Master.Factory, .GetUserParam("periodcombo-custom_query"))
                        period1.SelectedValue = .GetUserParam("o23_framework-period-" & strX18ID)
                    End If
            ...
            With Master.Factory.j03UserBL
                ...
                SetupGrid(.GetUserParam("o23_framework-filter_setting-" & strX18ID), .GetUserParam("o23_framework-filter_sql-" & strX18ID))
            End With
    ...
    Private Sub ReloadPage()
        Dim s As String = "o23_framework.aspx?x18id=" & Me.CurrentX18ID
    ...
    Private Sub cmdCĺearFilter_Click(sender As Object, e As EventArgs) Handles cmdCĺearFilter.Click
        With Master.Factory.j03UserBL
            .SetUserParam("o23_framework-filter_setting-" & Me.CurrentX18ID.ToString, "")
            .SetUserParam("o23_framework-filter_sql-" & Me.CurrentX18ID.ToString, "")
        End With
        ReloadPage()
    End Sub
    ...
    Private Sub grid1_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles grid1.NeedDataSource
        If _needFilterIsChanged Then
            With Master.Factory.j03UserBL
                .SetUserParam("o23_framework-filter_setting-" & Me.CurrentX18ID.ToString, grid1.GetFilterSetting())
                .SetUserParam("o23_framework-filter_sql-" & Me.CurrentX18ID.ToString, grid1.GetFilterExpression())
            End With
            RecalcVirtualRowCount()
        End If
        Dim mq As New BO.myQueryO23(Me.CurrentX23ID)
    ...
    Private Sub grid1_SortCommand(SortExpression As String, strOwnerTableName As String) Handles grid1.SortCommand
        Master.Factory.j03UserBL.SetUserParam("o23_framework-sort-" & Me.CurrentX18ID.ToString, SortExpression)
    End Sub
    ...
    Private Sub cbxPeriodType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxPeriodType.SelectedIndexChanged
        With Master.Factory.j03UserBL
            If Me.cbxPeriodType.SelectedIndex > 0 And Not period1.Visible Then
                .InhaleUserParams("periodcombo-custom_query", "o23_framework-period-" & Me.CurrentX18ID.ToString)
                period1.SetupData(Master.Factory, .GetUserParam("periodcombo-custom_query"))
                period1.SelectedValue = .GetUserParam("o23_framework-period-" & Me.CurrentX18ID.ToString)
            End If

            .SetUserParam("o23_framework-periodtype-" & Me.CurrentX18ID.ToString, Me.cbxPeriodType.SelectedValue)
        End With
    ...
    Private Sub cbxo23Validity_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxo23Validity.SelectedIndexChanged
        Master.Factory.j03UserBL.SetUserParam("o23_framework-filter_validity-" & Me.CurrentX18ID.ToString, Me.cbxo23Validity.SelectedValue)
        ReloadPage()
    End Sub
    ...
    Private Sub cbxPaging_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxPaging.SelectedIndexChanged
        ...
        Master.Factory.j03UserBL.SetUserParam("o23_framework-pagesize", Me.cbxPaging.SelectedValue)
        RecalcVirtualRowCount()
        grid1.Rebind(False)
    End Sub
End Class